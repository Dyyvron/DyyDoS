...
\x1b[0m        ╚═════╝ ╚═╝     ╚═╝  ╚═╝╚═╝  ╚═╝     ╚═════╝╚══════╝`);
    console.log(``);
    console.log(``);
    console.log(`[INFO!]»DoS Attack DONE✓ `);
    console.log('[INFO!]»Target: ' + parsedTarget.host + '\x1b[0m');
    console.log('[INFO!]»Duration: ' + args.time + '\x1b[0m');
    console.log('[INFO!]»Threads: ' + args.threads + '\x1b[0m');
    console.log('[INFO!]»Requests per second: ' + args.Rate + '\x1b[0m');
    console.log(`[INFO!]»Status: Succes!`);
    console.log(``);
